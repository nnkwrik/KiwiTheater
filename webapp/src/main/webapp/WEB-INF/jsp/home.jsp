...
<form class="layui-form" action="">
    <div class="layui-row ">
        <form id="" action="${pageContext.request.contextPath }/home" method="get">
            <div class="layui-col-md8 layui-col-md-offset1">
                    ...
                    <input type="text" name="keyword" required lay-verify="required" autocomplete="off" placeholder="" class="layui-input">
            </div>
            <div>
    ...
    <div class="layui-row ">
        ...
        <div class="layui-btn-container layui-col-md-offset3">
            <a href="${pageContext.request.contextPath }/home" class="layui-btn layui-btn-radius layui-btn-primary " lay-submit lay-filter="search">
                <i class="layui-icon" style="color: #FF5722">&#xe756;</i> 热门
            </a>
            <a href="${pageContext.request.contextPath }/home?category=1" class="layui-btn layui-btn-radius layui-btn-primary" >
                喜剧
            </a>
            <a href="${pageContext.request.contextPath }/home?category=2" class="layui-btn layui-btn-radius layui-btn-primary" >
                动画
            </a>
            <a href="${pageContext.request.contextPath }/home?category=3" class="layui-btn layui-btn-radius layui-btn-primary" >
                动作
            </a>
            <a href="${pageContext.request.contextPath }/home?category=4" class="layui-btn layui-btn-radius layui-btn-primary" >
                爱情
            </a>
            <a href="${pageContext.request.contextPath }/home?category=5" class="layui-btn layui-btn-radius layui-btn-primary" >
                恐怖
            </a>
